function show(platform, enabled, useSettingsInsteadOfPreferences) {
  ...
  if (useSettingsInsteadOfPreferences) {
    ...
    if (stateOnElement)
      stateOnElement.innerText =
        "ScrollStop's extension is currently on. You can turn it off in the Extensions section of Safari Settings.";
    if (stateOffElement)
      stateOffElement.innerText =
        "ScrollStop's extension is currently off. You can turn it on in the Extensions section of Safari Settings.";
    if (stateUnknownElement)
      stateUnknownElement.innerText =
        "You can turn on ScrollStop's extension in the Extensions section of Safari Settings.";
