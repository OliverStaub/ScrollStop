...
class HeadlessAlert {
  ...
  createElement() {
    ...
    this.backdrop.className = 'fixed inset-0 flex w-screen justify-center overflow-y-auto bg-zinc-950/15 px-2 py-2 transition duration-100 focus:outline-0 opacity-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50';
    ...
    grid.className = 'grid min-h-full grid-rows-[1fr_auto_1fr] justify-items-center p-8 sm:grid-rows-[1fr_auto_3fr] sm:p-4';
  ...
  updatePanelContent() {
    ...
    if (this.title) {
      ...
      titleEl.className = 'text-center text-base/6 font-semibold text-balance text-zinc-950 sm:text-left sm:text-sm/6 sm:text-wrap dark:text-white';
    ...
    if (this.description) {
      ...
      descEl.className = 'mt-2 text-center text-pretty sm:text-left text-base/6 text-zinc-500 sm:text-sm/6 dark:text-zinc-400';
    ...
    if (this.actions.length > 0) {
      ...
      actionsEl.className = 'mt-6 flex flex-col-reverse items-center justify-end gap-3 sm:mt-4 sm:flex-row';
  ...
  getActionButtonClasses(action) {
    ...
    if (action.outline) {
      baseClasses.push('border-zinc-950/10 text-zinc-950 hover:bg-zinc-950/2.5 active:bg-zinc-950/2.5 dark:border-white/15 dark:text-white dark:hover:bg-white/5 dark:active:bg-white/5');
    } else {
      baseClasses.push('border-transparent shadow-sm hover:shadow-md active:shadow-sm');
      const color = action.color || 'dark/zinc';
      const colorClasses = {
        'dark/zinc': 'text-white bg-zinc-900 border-zinc-950/90 hover:bg-zinc-800 active:bg-zinc-900',
