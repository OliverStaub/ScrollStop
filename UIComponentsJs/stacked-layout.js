/**
 * HeadlessStackedLayout - A comprehensive stacked layout with mobile sidebar
 *
 * USAGE EXAMPLES:
 *
 ...
 *
 * const layout = new HeadlessStackedLayout({
 *   navbar: navbar,
 *   sidebar: sidebar,
 *   children: content
 * });
...
class HeadlessStackedLayout {
  ...
  createHeader() {
    ...
    // Toggle button container (only visible on mobile in stacked layout)
    const toggleContainer = document.createElement('div');
    toggleContainer.className = 'py-2.5 lg:hidden';
