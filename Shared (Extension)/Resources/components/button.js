...
class HeadlessButton {
  ...
  static styles = {
    ...
    colors: {
      ...
      light: 'text-zinc-950 bg-white border-zinc-950/10 hover:bg-zinc-50 active:bg-zinc-100',
      'dark/white':
      ...
      white: 'text-zinc-950 bg-white border-zinc-950/10 hover:bg-zinc-50 active:bg-zinc-100',
      ...
      green: 'text-white bg-green-600 border-green-700/90 hover:bg-green-500 active:bg-green-600',
      emerald:
